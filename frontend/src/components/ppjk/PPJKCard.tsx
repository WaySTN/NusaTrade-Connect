  ...
  return (
    <div className="bg-white border border-[var(--color-border)] rounded-2xl overflow-hidden hover:shadow-xl hover-lift hover:border-[var(--color-primary-light)] hover:ring-4 hover:ring-[var(--color-primary-light)]/20 flex flex-col cursor-pointer group">
      ...
      <div className="p-5 flex gap-4">
        <div className="w-14 h-14 rounded-xl bg-[var(--color-bg-subtle)] border border-[var(--color-border)] flex items-center justify-center shrink-0 group-hover:bg-[var(--color-primary-light)] transition-colors duration-300">
          <Ship className="w-7 h-7 text-[var(--color-primary)]" />
        </div>
      ...
      <div className="mt-auto p-4 border-t border-[var(--color-border)] bg-slate-50/50 flex items-center justify-between">
        ...
        <Button variant="outline" size="sm" className="bg-white hover:bg-[var(--color-primary-light)] hover:text-[var(--color-primary)] hover:border-[var(--color-primary-light)] shadow-sm font-bold">
          Hubungi
        </Button>
      </div>
    </div>
